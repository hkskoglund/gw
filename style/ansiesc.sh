...
export STYLE_BEUFORT_0="$CSI$SGI_BACKGC$SGI_COLOR_BLACK"m
export STYLE_BEUFORT_1="$CSI$SGI_BACKGC$SGI_COLOR_BLUE"m
export STYLE_BEUFORT_2="$CSI$SGI_BACKGC$SGI_COLOR_BRIGHT_BLUE"m
export STYLE_BEUFORT_3="$CSI$SGI_BACKGC$SGI_COLOR_CYAN"m
export STYLE_BEUFORT_4="$CSI$SGI_BACKGC$SGI_COLOR_BRIGHT_CYAN;$SGI_FOREGC${SGI_COLOR_BLACK}m"
export STYLE_BEUFORT_5="$CSI$SGI_BACKGC$SGI_COLOR_GREEN"m
export STYLE_BEUFORT_6="$CSI$SGI_BACKGC$SGI_COLOR_BRIGHT_GREEN;$SGI_FOREGC${SGI_COLOR_BLACK}m"
export STYLE_BEUFORT_7="$CSI$SGI_BACKGC$SGI_COLOR_YELLOW;$SGI_FOREGC${SGI_COLOR_BLACK}m"
export STYLE_BEUFORT_8="$CSI$SGI_BACKGC$SGI_COLOR_BRIGHT_YELLOW;$SGI_FOREGC${SGI_COLOR_BLACK}m"
export STYLE_BEUFORT_9="$CSI$SGI_BACKGC$SGI_COLOR_RED"m
export STYLE_BEUFORT_10="$CSI$SGI_BACKGC$SGI_COLOR_BRIGHT_RED"m
export STYLE_BEUFORT_11="$CSI$SGI_BACKGC$SGI_COLOR_MAGENTA"m
