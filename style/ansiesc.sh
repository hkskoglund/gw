...
STYLE_BLACK_BRIGHTBLUE=$CSI$SGI_FOREGC$SGI_COLOR_BLACK";"$SGI_BACKGC$SGI_COLOR_WHITE"m"
...
export STYLE_LIMIT_LIVEDATA_OUTTEMP="${STYLE_LIMIT_LIVEDATA_OUTTEMP:=$STYLE_BLACK_BRIGHTBLUE}"
