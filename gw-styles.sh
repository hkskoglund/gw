...
ANSIESC_SGI_BRIGHTRED_BACKGROUND=$CSI$SGI_FOREGC$SGI_COLOR_WHITE";"$SGI_BACKGC$SGI_COLOR_BRIGHT_RED";${SGI_BLINK}m"
ANSIESC_SGI_BRIGHTRED=$CSI$SGI_FOREGC$SGI_COLOR$SGI_COLOR_BRIGHT_RED"m"
ANSIESC_SGI_BRIGHTBLUE=$CSI$SGI_FOREGC$SGI_COLOR_BRIGHT_BLUE"m"
ANSIESC_SGI_BRIGHTGREEN=$CSI$SGI_FOREGC$SGI_COLOR_BRIGHT_GREEN"m"
...
export STYLE_LIMIT_LIVEDATA=${STYLE_LIMIT_LIVEDATA:=$ANSI_ESC_SGI_INVERT}
export STYLE_LIMIT_LIVEDATA_OUTTEMP=${STYLE_LIMIT_LIVEDATA_OUTTEMP:=$ANSIESC_SGI_BRIGHTBLUE}
export STYLE_LIMIT_LIVEDATA_OUTTEMP_HIGH=${STYLE_LIMIT_LIVEDATA_OUTTEMP_HIGH:=$ANSIESC_SGI_BRIGHTRED}
export STYLE_LIMIT_LIVEDATA_INTEMP_LOW=${STYLE_LIMIT_LIVEDATA_INTEMP_LOW:=$ANSIESC_SGI_BRIGHTBLUE}
export STYLE_LIMIT_LIVEDATA_INTEMP_HIGH=${STYLE_LIMIT_LIVEDATA_INTEMP_HIGH:=$ANSIESC_SGI_BRIGHTRED}

export STYLE_BATTERY_LOW=${STYLE_BATTERY_LOW:=$ANSIESC_SGI_BRIGHTRED}
export STYLE_SIGNAL_LOW=${STYLE_SIGNAL_LOW:=$ANSIESC_SGI_BRIGHTRED}
export STYLE_LEAK=${STYLE_LEAK:="\a"$ANSIESC_SGI_BRIGHTRED_BACKGROUND} # add alert/bell \a if leakage detected
...
export STYLE_SENSOR_DISABLE=${STYLE_SENSOR_DISABLE:=$ANSIESC_SGI_BRIGHTRED}
export STYLE_SENSOR_SEARCH=${STYLE_SENSOR_SEARCH:=$ANSIESC_SGI_BRIGHTGREEN}
