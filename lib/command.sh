...
# set VALUE_COMMAND_NAME
 { 
    case "$1" in
       ...
       #? "$CMD_WRITE_SENSOR_ID_NEW")     VALUE_COMMAND_NAME='write sensor id new' ;; GW1000 fw1.6.8 does not have this command -> must use CMD_WRITE_SENSOR_ID
        ...
        "$CMD_READ_MULCH_OFFSET")       VALUE_COMMAND_NAME='read temp calibration' ;;
        "$CMD_WRITE_MULCH_OFFSET")      VALUE_COMMAND_NAME='write temp calibration' ;;
