...
export LIVEDATAHEADER_WH32TEMP_BATTERY="${LIVEDATAHEADER_WH32TEMP_BATTERY:="Temperature out battery"}"
export LIVEDATAHEADER_WH40RAINFALL_BATTERY="${LIVEDATAHEADER_WH40RAINFALL_BATTERY:="Rainfall battery"}"
export LIVEDATAHEADER_WH57LIGHTNING_BATTERY="${LIVEDATAHEADER_WH57LIGHTNING_BATTERY="Lightning battery"}"
