...
export LIVEDATAHEADER_WINDGUSTSPEED_BEUFORT="${LIVEDATAHEADER_WINDGUSTSPEED_BEUFORT:="Wind gust beufort"}"
...
export LIVEDATAHEADER_LEAK_YES="${LIVEDATAHEADER_LEAK_YES:="LEAK!"}"
...
export LIVEDATAGROUPHEADER_SOILMOISTURE_NO_COLOR="SOILMOISTURE"
export LIVEDATAGROUPHEADER_SOILTEMP_NO_COLOR="SOILTEMPERATURE"
export LIVEDATAGROUPHEADER_PM25_NO_COLOR="PM 2.5 AIR QUALITY"
export LIVEDATAGROUPHEADER_LEAFWETNESS_NO_COLOR="LEAFWETNESS"
export LIVEDATAGROUPHEADER_CO2_NO_COLOR="CO2"
export LIVEDATAGROUPHEADER_LIGHTNING_NO_COLOR="LIGHTNING"
export LIVEDATAGROUPHEADER_LEAK_NO_COLOR="LEAK"
export LIVEDATAGROUPHEADER_RAIN_NO_COLOR="RAIN"
export LIVEDATAGROUPHEADER_SOLAR_NO_COLOR="SOLAR"
export LIVEDATAGROUPHEADER_WIND_NO_COLOR="WIND"
export LIVEDATAGROUPHEADER_PRESSURE_NO_COLOR="PRESSURE"
export LIVEDATAGROUPHEADER_TEMPERATURE_NO_COLOR="TEMPERATURE"
export LIVEDATAGROUPHEADER_SYSTEM_NO_COLOR="SYSTEM"
export LIVEDATAGROUPHEADER_SENSOR_NO_COLOR="SENSOR"
...
export LIVEDATAHEADER_CO2_TEMPF="${LIVEDATAHEADER_CO2_TEMPF:="Temperature"}"
export LIVEDATAHEADER_CO2_HUMI="${LIVEDATAHEADER_CO2_HUMI:="Humidity"}"
export LIVEDATAHEADER_CO2_PM10="${LIVEDATAHEADER_CO2_PM10:="PM10"}"
export LIVEDATAHEADER_CO2_PM10_24HAVG="${LIVEDATAHEADER_CO2_PM10_24HAVG:="PM10 24h avg."}"
export LIVEDATAHEADER_CO2_PM25="${LIVEDATAHEADER_CO2_PM25:="PM25"}"
export LIVEDATAHEADER_CO2_PM25_24HAVG="${LIVEDATAHEADER_CO2_PM25_24HAVG:="PM25 24h avg."}"
export LIVEDATAHEADER_CO2_CO2="${LIVEDATAHEADER_CO2_CO2:="CO2"}"
export LIVEDATAHEADER_CO2_CO2_24HAVG="${LIVEDATAHEADER_CO2_CO2_24HAVG:="CO2 24h avg."}"
export LIVEDATAHEADER_CO2_BATTERY="${LIVEDATAHEADER_CO2_BATTERY:="CO2 battery"}"

export LIVEDATAHEADER_WH65_BATTERY="${LIVEDATAHEADER__BATTERY:="WH65 Weather station"}"
export LIVEDATAHEADER_WH68_BATTERY="${LIVEDATAHEADER__BATTERY:="WH68 Weather station"}"
export LIVEDATAHEADER_WH80_BATTERY="${LIVEDATAHEADER__BATTERY:="WH80 Weather station"}"

export LIVEDATAHEADER_OUTTEMP_BATTERY="${LIVEDATAHEADER_OUTTEMP_BATTERY:="Temperature out battery"}"
export LIVEDATAHEADER_RAINFALL_BATTERY="${LIVEDATAHEADER_RAINFALL_BATTERY:="Rainfall battery"}"
export LIVEDATAHEADER_LIGHTNING_BATTERY="${LIVEDATAHEADER_LIGHTNING_BATTERY="Lightning battery"}"
...
while [ "$N" -le "$SENSORTYPE_WH31TEMP_MAXCH" ]; do 
    ...
    eval export LIVEDATAHEADER_TEMP${N}_BATTERY=\"\$\{LIVEDATAHEADER_TEMP${N}_BATTERY:=\"Temperature $N battery\"\}\"
