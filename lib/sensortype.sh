...
SENSORIDSTATE_CONNECTED_UNICODE=${SENSORIDSTATE_CONNECTED_UNICODE:="✅"}
SENSORIDSTATE_CONNECTED=${SENSORIDSTATE_CONNECTED:="$SENSORIDSTATE_CONNECTED_UNICODE connected"}
SENSORIDSTATE_DISCONNECTED_UNICODE=${SENSORIDSTATE_DISCONNECTED_UNICODE:="🚫"}
SENSORIDSTATE_DISCONNECTED=${SENSORIDSTATE_DISCONNECTED:="$SENSORIDSTATE_CONNECTED_UNICODE disconnected"} #sensortype specified, but signal still 0/no received packets
SENSORIDSTATE_SEARCH_UNICODE=${SENSORIDSTATE_SEARCH_UNICODE:="🔎"}
SENSORIDSTATE_SEARCH=${SENSORIDSTATE_SEARCH:="$SENSORIDSTATE_SEARCH_UNICODE searching"}
SENSORIDSTATE_DISABLE_UNICODE=${SENSORIDSTATE_DISABLE_UNICODE:="⛔"}
SENSORIDSTATE_DISABLE=${SENSORIDSTATE_DISABLE:="$SENSORIDSTATE_DISABLE_UNICODE disabled"}
