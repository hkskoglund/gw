...
LOG_CMD="$LOG_CMD,$LIVEDATA_INTEMP,$LIVEDATA_INHUMI,$LIVEDATA_RELBARO"

if [ -n "$LIVEDATA_WINDSPEED" ]; then # assumes other variables are set
    LOG_CSV="$LOG_CSV,$LIVEDATA_WINDDIRECTION,$LIVEDATA_WINDDIRECTION_COMPASS,$LIVEDATA_WINDSPEED,$LIVEDATA_WINDGUSTSPEED"
fi
