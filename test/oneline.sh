...
case "$ONELINE_FORMAT" in
  text) 
    ...
    "$LIVEDATA_WINDDIRECTION_COMPASS_NEEDLE" "$LIVEDATA_WINDDIRECTION_COMPASS" "$LIVEDATA_WINDGUSTSPEED" "$LIVEDATA_WINDGUSTSPEED_BEUFORT_DESCRIPTION" "$LIVEDATA_WINDGUSTSPEED_BEUFORT"\
    "$LIVEDATA_RAINRATE_STATE" "$LIVEDATA_RAINRATE_STATE_DESCRIPTION"
