...
# compass widget
printf "$LIVEDATA_WINDDIRECTION_COMPASS_N_FMT\tSpeed:\t%6.1f $LIVEDATAUNIT_WIND\n$LIVEDATA_WINDDIRECTION_COMPASS_WE_FMT\tGust:\t%6.1f $LIVEDATAUNIT_WIND\n$LIVEDATA_WINDDIRECTION_COMPASS_S_FMT\tMax:\t%6.1f $LIVEDATAUNIT_WIND\n" "$LIVEDATA_WINDSPEED" "$LIVEDATA_WINDGUSTSPEED" "$LIVEDATA_WINDDAILYMAX"
