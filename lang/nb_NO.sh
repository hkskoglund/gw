...
LIVEDATAHEADER_WINDGUSTSPEED_BEUFORT="Vindkast beufort"
...
LIVEDATAHEADER_PM252_24HAVG="PM2.5 24t Hjemme stue"
LIVEDATAHEADER_PM252="PM2.5 Hjemme stue"
...
WIND_DIRECTION_W=V
     ...
     UV_RISK_LOW="LAV"
UV_RISK_MODERATE="MODERAT $UV_RISK_UNICODE"
    UV_RISK_HIGH="HØY $UV_RISK_UNICODE"
UV_RISK_VERYHIGH="VELDIG HØY $UV_RISK_UNICODE"
 UV_RISK_EXTREME="EKSTREM $UV_RISK_UNICODE"
...
SENSORIDSTATE_CONNECTED="$SENSORIDSTATE_CONNECTED_UNICODE tilkoblet"
SENSORIDSTATE_DISCONNECTED="$SENSORIDSTATE_DISCONNECTED_UNICODE frakoblet"
SENSORIDSTATE_SEARCH="$SENSORIDSTATE_SEARCH_UNICODE søker"
SENSORIDSTATE_DISABLE="$SENSORIDSTATE_DISABLE_UNICODE deaktivert"
