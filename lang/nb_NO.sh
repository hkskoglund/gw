...
LIVEDATA_SENSOR_HEADER_CONNECTED='Tilkoblet'
LIVEDATA_SENSOR_HEADER_SEARCHING="Søker"
LIVEDATA_SENSOR_HEADER_DISABLED="Deaktivert"
LIVEDATA_SENSOR_HEADER_PROTOCOL="Protokoll"
